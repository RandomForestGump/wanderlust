...
interface IERC20 {
    ...
    function Registration(address owner, address buyer, uint numTokens) external returns (bool);
...
contract ERC20MYN is IERC20 {

    string public constant name = "ERC20MYN";
   ...
   constructor() public {  
    ...
    function balanceOf(address tokenOwner) public virtual override view returns (uint) {
...
function Registration(address owner, address buyer, uint numTokens) public virtual override returns (bool) {
        require(numTokens <= balances[owner]);    
        // require(numTokens <= allowed[owner][msg.sender]);
